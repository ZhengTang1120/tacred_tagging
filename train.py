...
parser.add_argument('--chunk_id', type=str, help='chunk id')
...
dev_batch = DataLoader(opt['data_dir'] + '/train_%s.json'%opt["chunk_id"], opt['batch_size'], opt, tokenizer, opt['data_dir'] + '/tagging_train_%s.txt'%opt["chunk_id"], evaluation=True)
