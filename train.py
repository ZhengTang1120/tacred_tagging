...
train_batch = DataLoader(opt['data_dir'] + '/semeval_train.json', opt['batch_size'], opt, tokenizer)
train_num_example = train_batch.num_examples
train_batch = list(train_batch)
dev_batch = DataLoader(opt['data_dir'] + '/semeval_dev.json', opt['batch_size'], opt, tokenizer, True)
